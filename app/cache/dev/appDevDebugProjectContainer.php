...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'admin.cpo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AdminBundle\Service\CPO A AdminBundle\Service\CPO instance.
     */
    protected function getAdmin_CpoService()
    {
        return $this->services['admin.cpo'] = new \AdminBundle\Service\CPO();
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/AdminBundle/Resources/config/doctrine') => 'AdminBundle\\Entity'));
        ...
        $c->setEntityNamespaces(array('AdminBundle' => 'AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e031fffd065a8308414565218e691d10892ff9a4cb28e2286c3bacc941c258ac');
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher(NULL, 'admin.yjj.symfony path: ^/admin');
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, 'admin_homepage'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'admin_logout'));
        ...
        $k->setOptions(array('login_path' => 'admin_login', 'default_target_path' => 'admin_admin', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $l->setOptions(array('login_path' => 'admin_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $a, $c), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $i, 'secured_area', $k, $l, array('check_path' => 'admin_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55df2257a51949.01486725', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $i, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $i, 'admin_login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/AssistantBundle/Resources/views'), 'Assistant');
        $instance->addPath(($this->targetDirs[3].'/src/AdminBundle/Resources/views'), 'Admin');
        $instance->addPath(($this->targetDirs[3].'/src/BbsBundle/Resources/views'), 'Bbs');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ec4a0f0ba573331386700c3520498820977a4ba1');
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('yangjj', '123', array(0 => 'ROLE_ADMIN')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AssistantBundle' => 'AssistantBundle\\AssistantBundle',
                'AdminBundle' => 'AdminBundle\\AdminBundle',
                'BbsBundle' => 'BbsBundle\\BbsBundle',
            ...
            'secret' => 'ec4a0f0ba573331386700c3520498820977a4ba1',
            'locale' => 'en',
            ...
            'kernel.secret' => 'ec4a0f0ba573331386700c3520498820977a4ba1',
